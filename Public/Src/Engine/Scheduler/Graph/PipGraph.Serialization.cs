...
namespace BuildXL.Scheduler.Graph
{
    public sealed partial class PipGraph
    {
        ...
        private sealed class SerializedState
        {
            ...
            public readonly ConcurrentBigSet<(AbsolutePath path, bool isShared)> OutputDirectoryRoots;
            ...
            public static async Task<SerializedState> ReadAsync(BuildXLReader reader)
            {
                ...
                var outputDirectoryRoots = ConcurrentBigSet<(AbsolutePath path, bool isShared)>.Deserialize(
                    reader,
                    () => (path: reader.ReadAbsolutePath(), isShared: reader.ReadBoolean()));
            ...
            public void Serialize(BuildXLWriter writer)
            {
                ...
                OutputDirectoryRoots.Serialize(
                    ...
                    tuple =>
                    {
                        writer.Write(tuple.path);
                        writer.Write(tuple.isShared);
                    });
