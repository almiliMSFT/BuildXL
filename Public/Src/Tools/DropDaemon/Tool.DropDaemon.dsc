...
export namespace DropDaemon {
    ...
    export const exe = !BuildXLSdk.isDropToolingEnabled ? undefined : BuildXLSdk.executable({
        ...
        references: [
            ...
            importFrom("ArtifactServices.App.Shared").withQualifier({targetFramework: "net472"}).pkg,
            importFrom("ArtifactServices.App.Shared.Cache").withQualifier({targetFramework: "net472"}).pkg,
            importFrom("Drop.App.Core").withQualifier({targetFramework: "net472"}).pkg,
            importFrom("Drop.Client").withQualifier({targetFramework: "net472"}).pkg,
            importFrom("Drop.RemotableClient.Interfaces").withQualifier({targetFramework: "net472"}).pkg,
            importFrom("ItemStore.Shared").withQualifier({targetFramework: "net472"}).pkg,
